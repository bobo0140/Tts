...
LIVE_SYSTEM_PROMPT = (
    ...
    # Native-audio моделите разпознават езика сами и понякога дърпат към
    # руски или полски. Затова инструкцията е изрична и в началото.
    "ГОВОРИ НА ЧИСТ, ЕСТЕСТВЕН БЪЛГАРСКИ ЕЗИК, с правилно българско "
    "произношение и ударения, като роден говорител от София. НЕ говори с "
    "руски, сръбски или полски акцент. Не смесвай думи от други езици. "
    "Чуждите имена в чата произнасяй както биха ги произнесли българи. "
    "Говориш кратко и разговорно — по 1-2 изречения. "
